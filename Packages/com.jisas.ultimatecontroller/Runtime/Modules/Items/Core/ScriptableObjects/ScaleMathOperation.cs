...
public class ScaleMathOperation : ScriptableObject
{
    ...
    public void SubscribeToAttributes(StatisticsComponent statsComponent)
    {
        if (statsComponent != null)
        {
            ...
            {
                foreach (UltimateController.StatisticsSystem.Attribute primaryAttribute in statsComponent.primaryAttributes)
                {
            ...
            {
                foreach (UltimateController.StatisticsSystem.Attribute attribute in statsComponent.attributes)
                {
