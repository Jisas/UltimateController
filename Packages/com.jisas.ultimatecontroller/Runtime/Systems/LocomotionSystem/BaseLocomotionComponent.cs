...
{
    [RequireComponent(typeof(Animator), typeof(AnimatorDataHandler), typeof(CharacterController))]
    public abstract class BaseLocomotionComponent : MonoBehaviour
    {
        ...
        public AnimatorOverrideController OverrideAnimatorController { get; protected set; }
        ...
        public int MotionMultiplier
        {
            get => _animIDMotionMultiplier;
        }
        public string FullBodyMaskName
        {
            get => "FullBodyMask";
        }
        public string LowerBodyMaskName
        {
            get => "LowerBodyMask";
        }
        public string UpperBodyMaskName
        {
            get => "UpperBodyMask";
        }
        public string RightHandMaskName
        {
            get => "RightHandMask";
        }
        public string RightAndLeftHandMaskName
        {
            get => "RightAndLeftHandMask";
        }
        public Vector2 CenterScreenPoint
        {
            get => new(Screen.width / 2f, Screen.height / 2f);
        }
        public LocomotionMap CurrentMap
        {
            get => currentMap;
        }
        ...
        private void Start()
        {
            ...
            m_AnimDataHanlder.RegisterAnimatorData();
            OnStart();
        }
        private void Update()
        {
        ...
        public void SetLocomotionMap(string mapName)
        {
            ...
            OverrideAnimatorController = currentMap.Controller;
            m_Animator.runtimeAnimatorController = OverrideAnimatorController;
        }
        ...
        protected IEnumerator IdleBreaks()
        {
            ...
            OverrideAnimatorController["IdleBreak_Base"] = motion;
