...
namespace UltimateFramework.AI.Task
{
    public class Attack : Node
    {
        ...
        public override NodeState Evaluate()
        {
            ...
            {
                GameObject currentWeapon = m_InventoryAndEquipment.GetCurrentRightWeaponObject();
                ...
                attackInputAction.ExecuteAction(actionTag, actionPriority, currentWeaponName, isBaseAction);
