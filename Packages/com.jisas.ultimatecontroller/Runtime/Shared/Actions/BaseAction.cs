...
namespace UltimateController.ActionsSystem
{
    ...
    public class BaseAction : ScriptableObject
    {
        ...
        protected AnimatorDataHandler m_AnimatoDataHandler;
        ...
        public void SetupAction(GameObject owner)
        {
            ...
            m_AnimatoDataHandler = owner.GetComponent<AnimatorDataHandler>();
            AnimatorData = m_AnimatoDataHandler.GetData();
        }
        ...
        protected void PlayActionAnimation(Animator animator, int layerIndex, ActionStructure currentStructure, float motionSpeed, int[] excludeLayersForDesactive = default, int[] excludeLayersForActive = default, CancellationToken cancelToken = default)
        {
            if (!cancelToken.IsCancellationRequested)
            {
                ...
                bool isUpperBodyLayer = layerIndex == animator.GetLayerIndex(m_AnimatoDataHandler.UpperBodyMaskName);
                ...
                animator.SetFloat(m_AnimatoDataHandler.MotionMultiplier, motionSpeed);
        ...
        public void HanddlerApplyModifiers(bool revert = false)
        {
            if (CurrentStructure.modifiers.Count > 0)
            {
                ...
                foreach (var modifier in CurrentStructure.modifiers)
                {
                    ...
                    var isPercentage = valueType == UltimateController.Utils.ValueType.Percentage;
