...
namespace UltimateController.AnimatorDataSystem
{
    public class IgnoreBehaviour : StateMachineBehaviour
    {
        ...
        override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
        {
            ...
            m_AnimatorDataHandler = animator.gameObject.GetComponent<AnimatorDataHandler>();
            ...
            foreach (var item in thingsToIgnore)
            {
                switch (item)
                {
                    ...
                    case IgnoreOptions.Crouch:
                        ...
                        if (currentlocomotionMap.useOverrideAtStartup && (overrideLayerMaskName == m_AnimatorDataHandler.LowerBodyMaskName || overrideLayerMaskName == m_AnimatorDataHandler.UpperBodyMaskName))
                        {
