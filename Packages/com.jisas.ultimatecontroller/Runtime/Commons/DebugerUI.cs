...
public class DebugerUI : MonoBehaviour
{
    ...
    // References
    private PlayerLocomotionComponent m_Locomotion;
    ...
    void Start()
    {
        if (enableDebugMode)
        {
            for (int i = 0; i < transform.childCount; i++)
            {
                ...
                if (currentChild.CompareTag("Debuger"))
                {
                    document = currentChild.GetComponent<UIDocument>();
            ...
            // References
            m_Locomotion = GetComponent<PlayerLocomotionComponent>();
            m_Statistics = GetComponent<StatisticsComponent>();
            m_InventoryAndEquipment = GetComponent<PlayerInventoryAndEquipment>();
