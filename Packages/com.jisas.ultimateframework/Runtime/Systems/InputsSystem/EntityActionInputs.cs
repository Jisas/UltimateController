...
{
    public class EntityActionInputs : MonoBehaviour
    {
        ...
        #region Func Events
        public Func<string, ActionsPriority, string, Task> ExecuteBaseAction;
        public Func<string, ActionsPriority, string, Task> ExecuteSpecificAction;
        #endregion
