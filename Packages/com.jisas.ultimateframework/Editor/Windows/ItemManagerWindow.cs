...
public class ItemManagerWindow : EditorWindow
{
    ...
    private Label quesItemAmountLabel;
    ...
    private void CreateGUI()
    {
        ...
        quesItemAmountLabel = base_Root.Q<Label>("quest-items-amount");
        ...
        quesItemAmountLabel.text = $"{itemDB.GetCountByTypeOnItemList(ItemType.QuestItem)} items";
